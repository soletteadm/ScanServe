...
import { idlFactory } from './prodtoken.did.js';
export { idlFactory } from './prodtoken.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PRODTOKEN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./prodtoken.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the prodtoken canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./prodtoken.did.js")._SERVICE>}
 */
export const prodtoken = createActor(canisterId);
