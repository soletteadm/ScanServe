...
import { idlFactory } from './lotto.did.js';
export { idlFactory } from './lotto.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LOTTO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./lotto.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the lotto canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./lotto.did.js")._SERVICE>}
 */
export const lotto = createActor(canisterId);
